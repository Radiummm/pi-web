...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "permissions.title": "Approval mode",
    "permissions.heading": "Let Pi act without asking for approval?",
    "permissions.workMode": "Work mode",
    "permissions.planModeDescription": "Analyze and produce a plan without changing files or running shell commands.",
    "permissions.workspace": "Ask for external access",
    "permissions.workspaceDescription": "Always ask before accessing files outside the workspace, using the internet, or running shell commands.",
    "permissions.risk": "Ask for risky operations",
    "permissions.riskDescription": "Only ask for detected risks such as external paths, sensitive files, deletion, elevation, publishing, and forceful Git commands.",
    "permissions.full": "Full access",
    "permissions.fullDescription": "Use the internet and any file on this computer without approval.",
    "permissions.notInstalled": "Install @gotgenes/pi-permission-system to use approval controls.",
    "permissions.saving": "Applying approval mode…",
    ...
    "sidebar.newFolder": "New conversation folder",
    "sidebar.folderName": "Folder name",
    "sidebar.renameFolder": "Rename folder",
    "sidebar.deleteFolder": "Delete folder",
    "sidebar.deleteFolderConfirm": "Delete folder “{name}”? Conversations will move to Unfiled.",
    "sidebar.dropSessionsHere": "Drop conversations here",
    "sidebar.moveToFolder": "Move to",
    "sidebar.unfiled": "Unfiled",
    "sidebar.resizeHistoryExplorer": "Drag to resize conversation history and file explorer; double-click to reset",
    ...
    "files.browseFolder": "Browse another folder",
    "files.goToParentFolder": "Go to parent folder",
    "files.returnToWorkspace": "Return to workspace folder",
    ...
    "chat.enablePlanMode": "Enable read-only plan mode",
    "chat.disablePlanMode": "Disable plan mode",
    "chat.askPi": "Ask Pi",
    ...
    "chat.collapseQuoteChat": "Collapse chat window",
    "chat.expandQuoteChat": "Expand chat window",
    ...
    "chat.errorRequestCancelled": "The model request was cancelled before completion ({source}).",
    "chat.errorResponseTerminated": "The upstream model terminated the response stream before completion ({source}).",
    "chat.errorNetworkFailure": "The connection to the model service failed ({source}). Check the network or proxy connection.",
    "chat.errorResponseInterrupted": "The model response stream ended unexpectedly before completion ({source}).",
    "chat.errorRequestTimeout": "The model service did not finish the response before the request timed out ({source}).",
    "chat.errorUnknownProvider": "The model request failed without a detailed provider error ({source}).",
    "chat.errorPartialPreserved": "The partial response received before the interruption was preserved.",
    "chat.errorTechnicalDetail": "Technical detail: {detail}",
