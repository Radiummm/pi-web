...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "common.skills": "技能",
    "common.plugins": "插件",
    "permissions.title": "请求批准",
    "permissions.heading": "允许 Pi 不经批准执行操作吗？",
    "permissions.workMode": "工作模式",
    "permissions.planModeDescription": "只分析并制定计划，不修改文件或运行 Shell 命令。",
    "permissions.workspace": "始终询问",
    "permissions.workspaceDescription": "编辑工作区外文件、使用互联网或运行 Shell 命令时始终询问。",
    "permissions.risk": "仅风险操作询问",
    "permissions.riskDescription": "仅对检测到的风险操作请求批准，包括外部路径、敏感文件、删除、提权、发布和强制 Git 操作。",
    "permissions.full": "完全访问权限",
    "permissions.fullDescription": "可不受限制地访问互联网和您电脑上的任何文件。",
    "permissions.notInstalled": "请先安装 @gotgenes/pi-permission-system 以使用批准控制。",
    "permissions.saving": "正在应用权限模式…",
    "terminal.title": "终端",
    "terminal.open": "打开终端",
    "terminal.chat": "聊天",
    ...
    "sidebar.newFolder": "新建对话文件夹",
    "sidebar.folderName": "文件夹名称",
    "sidebar.renameFolder": "重命名文件夹",
    "sidebar.deleteFolder": "删除文件夹",
    "sidebar.deleteFolderConfirm": "删除文件夹“{name}”？其中的对话将移到未分类。",
    "sidebar.dropSessionsHere": "将对话拖到这里",
    "sidebar.moveToFolder": "移动到",
    "sidebar.unfiled": "未分类",
    "sidebar.resizeHistoryExplorer": "拖动以调整对话历史和文件浏览器大小；双击恢复默认",
    ...
    "files.browseFolder": "浏览其他文件夹",
    "files.goToParentFolder": "转到上级目录",
    "files.returnToWorkspace": "返回当前工作目录",
    ...
    "chat.send": "发送",
    "chat.planMode": "计划模式",
    "chat.enablePlanMode": "开启只读计划模式",
    "chat.disablePlanMode": "关闭计划模式",
    "chat.askPi": "询问 Pi",
    "chat.askSelection": "询问选中的文字",
    "chat.askInCurrent": "在当前对话询问",
    "chat.askInNewChat": "在新对话询问",
    "chat.newQuoteChat": "关于选中文字的新对话",
    "chat.collapseQuoteChat": "折叠对话窗口",
    "chat.expandQuoteChat": "展开对话窗口",
    ...
    "chat.errorRequestCancelled": "模型请求在完成前被取消（{source}）。",
    "chat.errorResponseTerminated": "上游模型在回答完成前终止了响应流（{source}）。",
    "chat.errorNetworkFailure": "无法连接模型服务（{source}），请检查网络或代理连接。",
    "chat.errorResponseInterrupted": "模型响应流在完成前意外中断（{source}）。",
    "chat.errorRequestTimeout": "模型服务未能在请求超时前完成回答（{source}）。",
    "chat.errorUnknownProvider": "模型请求失败，但提供方没有返回具体原因（{source}）。",
    "chat.errorPartialPreserved": "中断前已收到的部分回答已保留。",
    "chat.errorTechnicalDetail": "技术详情：{detail}",
    "i18n.continuing": "继续中…",
    "i18n.skills": "技能",
    "i18n.plugins": "插件",
    "i18n.addSkill": "添加技能",
