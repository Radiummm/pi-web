...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "common.plugins": "外掛",
    "common.settings": "設定",
    "permissions.title": "核准模式",
    "permissions.heading": "允許 Pi 不經核准執行操作嗎？",
    "permissions.workMode": "工作模式",
    "permissions.planModeDescription": "只分析並制定計畫，不修改檔案或執行 Shell 指令。",
    "permissions.workspace": "一律詢問",
    "permissions.workspaceDescription": "存取工作區外檔案、使用網路或執行 Shell 指令前一律詢問。",
    "permissions.risk": "僅風險操作詢問",
    "permissions.riskDescription": "僅對外部路徑、敏感檔案、刪除、提權、發布和強制 Git 操作等風險請求核准。",
    "permissions.full": "完整存取權",
    "permissions.fullDescription": "可不受限制地存取網路和此電腦上的任何檔案。",
    "permissions.notInstalled": "請先安裝 @gotgenes/pi-permission-system 以使用核准控制。",
    "permissions.saving": "正在套用核准模式…",
    "settings.title": "設定",
    "settings.general": "一般",
    ...
    "sidebar.newFolder": "新增對話資料夾",
    "sidebar.folderName": "資料夾名稱",
    "sidebar.renameFolder": "重新命名資料夾",
    "sidebar.deleteFolder": "刪除資料夾",
    "sidebar.deleteFolderConfirm": "刪除資料夾「{name}」？其中的對話將移至未分類。",
    "sidebar.dropSessionsHere": "將對話拖曳到這裡",
    "sidebar.unfiled": "未分類",
    "sidebar.resizeHistoryExplorer": "拖曳以調整對話歷史與檔案瀏覽器大小；按兩下還原預設值",
    ...
    "files.browseFolder": "瀏覽其他資料夾",
    "files.goToParentFolder": "前往上層資料夾",
    "files.returnToWorkspace": "返回工作區資料夾",
    ...
    "chat.quotedFromCurrent": "引用自目前對話",
    "chat.quoteIntro": "關於這段內容：",
    "chat.quoteQuestion": "我的問題是：",
    "chat.collapseQuoteChat": "摺疊對話視窗",
    "chat.expandQuoteChat": "展開對話視窗",
    ...
    "chat.shell": "Shell",
    "chat.planMode": "規劃",
    "chat.planModeEnable": "啟用唯讀規劃模式",
    "chat.planModeDisable": "關閉規劃模式並還原工具",
    "terminal.title": "終端機",
    ...
    "chat.errorRequestCancelled": "模型請求在完成前已取消（{source}）。",
    "chat.errorResponseTerminated": "上游模型在回答完成前終止了回應串流（{source}）。",
    "chat.errorNetworkFailure": "無法連線至模型服務（{source}），請檢查網路或代理連線。",
    "chat.errorResponseInterrupted": "模型回應串流在完成前意外中斷（{source}）。",
    "chat.errorRequestTimeout": "模型服務未能在請求逾時前完成回答（{source}）。",
    "chat.errorUnknownProvider": "模型請求失敗，但提供者未回傳詳細原因（{source}）。",
    "chat.errorPartialPreserved": "中斷前已收到的部分回答已保留。",
    "chat.errorTechnicalDetail": "技術細節：{detail}",
